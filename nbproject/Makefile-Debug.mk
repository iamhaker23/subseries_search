...
${OBJECTDIR}/series.o: series.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/series.o series.c

${OBJECTDIR}/subseriesMatcher.o: subseriesMatcher.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/subseriesMatcher.o subseriesMatcher.c
...
${TESTDIR}/tests/seriesSimpleTest.o: tests/seriesSimpleTest.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -std=c11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/seriesSimpleTest.o tests/seriesSimpleTest.c


${TESTDIR}/tests/subseriesMatcherSimpleTest.o: tests/subseriesMatcherSimpleTest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -std=c11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/subseriesMatcherSimpleTest.o tests/subseriesMatcherSimpleTest.c
...
${OBJECTDIR}/series_nomain.o: ${OBJECTDIR}/series.o series.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/series_nomain.o series.c;\
	else  \
...
${OBJECTDIR}/subseriesMatcher_nomain.o: ${OBJECTDIR}/subseriesMatcher.o subseriesMatcher.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/subseriesMatcher_nomain.o subseriesMatcher.c;\
	else  \
